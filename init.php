...
{
    $client_id = "fd78c92900b96f70ae48";
    $redirect_url = "http://localhost/codefun/home.php";
...
{
    $client_id = "fd78c92900b96f70ae48";
    $redirect_url = "http://localhost/codefun/callback.php";
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        if (isset($_GET['code'])) {
            $code = $_GET['code'];
            $post = http_build_query(array(
                    ...
                    'client_secret' => '0defada60581efc987316718740bf37f2604b0fd',
                    'code' => $code,
